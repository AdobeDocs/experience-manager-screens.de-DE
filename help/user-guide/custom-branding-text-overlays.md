...
1. Navigieren Sie zu Ihrem AEM Screens-Projekt mit dem Titel **`customstyle`** > **Kanäle** > **DemoBrand**. Wählen Sie den Kanal aus und klicken Sie auf **Bearbeiten** in der Aktionsleiste aus.
