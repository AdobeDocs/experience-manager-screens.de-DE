...
>[!NOTE]
>
>Weitere Informationen zum AEM Screens-Player finden Sie unter:AEM Screens Player-DownloadsArbeiten mit dem AEM Screens-Player](working-with-screens-player.md)
