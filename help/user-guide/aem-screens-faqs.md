...
### &#x200B;2. Gibt es eine Möglichkeit, HTTP-GET-Anfragen mit einer Form der Authentifizierung in HTTP-POST umzuwandeln? {#is-there-a-way-to-transform-http-get-requests-into-http-post-with-some-form-of-authentication}
